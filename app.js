...
// console.log(lib.Currency.GetCurrencyName('Rupee'))
...
// console.log(lib.Designation.Validate(lib.Designation.Random(10,2,3,true)))
...
// lib.Domain.Add("GoDaddy","specific")
...
// console.log(Validate(lib.Name.Random(8,1,8,true)))  
// console.log(Validate(lib.Name.Random(8,2,8,true),2))
